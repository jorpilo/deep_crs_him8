...
if __name__ == "__main__":
    ...
    parser.add_argument('filename',
                        help='Name to the dataset to calculate the PCA on', type=str, metavar="filename")
    parser.add_argument('--ncomp',help='number of components to calculate, default 100', type=int, default=100, metavar="ncomp")
